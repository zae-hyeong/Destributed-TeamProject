...
public class SharingApps_Cli_ex1 {
	...
	{
		SharingApps_Cli_ex1 client = new SharingApps_Cli_ex1();
		CMClientStub cmStub = client.getClientStub();
		cmStub.setAppEventHandler(client.getClientEventHandler());
		
		client.StartCM(); // 서버 연결
		client.testLoginDS(); // 로그인
		 client.enrollApps("calc#App for calculation#1#a+b \n a-b \n a * b \n a / b  \nExpected result: a + b(a, b is num.)"); 
